...
class Api{
  ...
  Future<dynamic> post({required String url, @required body, @required String? token}) async{
    ...
    http.Response response = await http.post(Uri.parse(url),body: body, );
     if(response.statusCode == 200){
      ...
      return data;
       ...
       throw Exception('there is a problem with status code ${response.statusCode} and body: ${jsonDecode(response.body)}');
     }
  }
